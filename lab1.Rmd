 ...
 **1) С помощью сервиса 2ip.ru определим следующие признаки:**
...
**2) Просканируем порты, используя операционную систему Linux, выполнив команду:**
  <br><br>
```{}
nmap <домен_компании>/<ip_адрес> -p <номер_порта>
```
<br>
**3) При помощи сервиса REG.ru определим кто занимается хостингом данной компании;**<br>
...
<font size=5> В данной работе с помощью сервисов 2ip.ru,Nmap, Linkonavt.ru,REG.ru, Linkonavt.ru, я научилась получать различную информацию(телефон, местонахождение,e-mail, порты, web-приложения, хостинг, ip-адрес) об организациях.</font>